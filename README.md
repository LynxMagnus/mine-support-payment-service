...
| POSTGRES_DB                    | Database name                           | no        | ffc-demo-payment          |                             | the service can be run against an external database by setting the database host and schema credentials as env vars |
